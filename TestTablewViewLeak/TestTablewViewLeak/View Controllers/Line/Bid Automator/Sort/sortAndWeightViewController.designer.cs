...
{
    [Register ("BAsortAndWeightViewController")]
    partial class BAsortAndWeightViewController
    {
        [Outlet]
        ...
        [Outlet]
        UIKit.UISegmentedControl SegReserveAndBlank { get; set; }
        ...
        [Action ("reserveAndBlankSegmentClicked:")]
        partial void reserveAndBlankSegmentClicked (Foundation.NSObject sender);
