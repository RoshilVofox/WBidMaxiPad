	...
	namespace WBid.WBidiPad.iOS
	{
	    public partial class ModernViewCell : UITableViewCell
	    {
	        class MyPopDelegate : UIPopoverControllerDelegate
	        {
				...
				public ModernViewControllerSource Source;
	...
	//          }
	//      }
	        public void BindOverLayData(bool ishidden)
	        {

	            Fade (OverLayView, !ishidden, (double)0.2);
	        ...
	        public void BindOverLayDataLine(Line line)
	        {
	            //211 - line 86
	            lblOverLayLineNumber.Text = (this.Tag +1) + "- line "+line.LineDisplay.ToString();
	...
	NSObject arrObserver,arrShowPopOverNotification;
        ...
        public void createCellBorder(Line line, UITableViewCell cell)
        {
            ...
            viewOrder.BackgroundColor = UIColor.Clear;
            viewOrder.Hidden = true;
            RemoveLayer(line.LineNum.ToString(), line);
...

            {
                ...
                viewOrder.BackgroundColor = UIColor.Blue;
            ...
            if (imgBorder.Layer.Sublayers != null)
		{
			...
			public void RemoveLayer(string linenumber , Line line)
	{
            if (imgBorder.Layer.Sublayers != null)
		{
                foreach (CAShapeLayer layer in imgBorder.Layer.Sublayers)
	...
	//          addColTap.NumberOfTapsRequired = 1;
	        ...
	        void HandleToolTip (UITapGestureRecognizer obj)
	        {
	            ...
	            if (popoverController == null) {
	                ...
	                popoverController.Delegate = new MyPopDelegate2 (this);
	...
	//      }
	        ...
	        void HandleAdditionalColumn(UITapGestureRecognizer obj)
	        {
	            ...
	            arrObserver=NSNotificationCenter.DefaultCenter.AddObserver (new Foundation.NSString ("dismissModernPopover"), dismissPopover);
