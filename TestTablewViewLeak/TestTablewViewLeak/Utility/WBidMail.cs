...
namespace WBid.WBidiPad.iOS.Utility
{
    public class WBidMail
    {
        ...
        public void SendCrashMail(string bidData)
        {
            ...
            mailInfo.ToAddress = " ipadcrash@wbidmax.com";
        ...
        public void SendContactUsMailtoAdmin(string mailcontent, string fromId, string subject)
        {
            MailInfo mailInfo = new MailInfo();
            mailInfo.Alias = GetmailAlias();
            //mailInfo.ToAddress = "admin@wbidmax.com";
        ...
        private string GetmailAlias()
        {
            try
            {
                if (GlobalSettings.WbidUserContent.UserInformation != null)
                {
                    return GlobalSettings.WbidUserContent.UserInformation.FirstName + " " + GlobalSettings.WbidUserContent.UserInformation.LastName + "-" + GlobalSettings.WbidUserContent.UserInformation.EmpNo+"WBid-iPad";
                }
                else
                    return string.Empty;
            }
