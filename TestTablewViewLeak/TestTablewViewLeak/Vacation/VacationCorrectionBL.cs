...
namespace VacationCorrection
{
    public class VacationCorrectionBL
    {
            ...
            foreach (var flt in flights)
            {
                ...
                if (tripType == "VOF")
                {
                    ...
                    if (flt.ArrSta == domicile)
                    {
                        ...
                        //Frank Add 3/2/2021 - Going back to original code
                        //I will eventually need to replace this whole method to look for all sips and take the latest sip in a sequence
        ...
        private void CalcVDvsRC(VacationTrip vacTrip, Trip trip, DateTime tripDate)
        {
            ...
            // split cost for each le.g as:  totVD - (reserveCost + aditnlVO).  
