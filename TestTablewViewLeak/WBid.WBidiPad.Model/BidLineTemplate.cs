...
namespace WBid.WBidiPad.Model
{
    ...
    public class BidLineTemplate 
    {
       ...
       // public string DayOfWeek { get; set; }
        ...
        /// <summary>
        /// Used to indicate the flight drop sequence number in the case of the split duutyperiod
        /// For VOF split trip  , the value indicates the flights upto that number will be the VD flight
        /// For VOB split trip, the value indicates the flights upto that number will be the VO flight
        /// </summary>
        [ProtoMember(28)]
