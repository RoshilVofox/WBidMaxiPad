    ...
    public class ConstraintPoints
    {
        ...
        public bool IsConstraint()
        {
            return AcftChanges || AmPmNte || BlkDaysOff || DaysOfMonthOff || CmtDhds || CmtLines || LegsPerDutPd || LegsPerTrip || NumDaysOff
                ...
                || InternationalConstraint || NonConusConstraint || WorkBlklength || WeekDayConstraint || WorkDay || InterNonConus || OvernightCityBulk || TripLengthHard||CmtLinesAuto || CitiesLegs|| Commute || ETOPS || AdavanceETOPSConstraint || ReserveETOPSConstraint
                || StartDay || ReportRelease || MixedHardandReserve;
        }
