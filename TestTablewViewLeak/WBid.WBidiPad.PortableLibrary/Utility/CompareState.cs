	...
	public class CompareState
	{
		...
		private bool CompareCxWtState(CxWtState stateFileContentCxWtState, CxWtState tempContentCxWtState)
		{
			...
			if (stateFileContentCxWtState.CL.Cx != tempContentCxWtState.CL.Cx || stateFileContentCxWtState.CL.Wt != tempContentCxWtState.CL.Wt)
				return false;
			if (stateFileContentCxWtState.CLAuto.Cx != tempContentCxWtState.CLAuto.Cx || stateFileContentCxWtState.CLAuto.Wt != tempContentCxWtState.CLAuto.Wt)
				return false;
			if (stateFileContentCxWtState.CitiesLegs.Cx != tempContentCxWtState.CitiesLegs.Cx || stateFileContentCxWtState.CitiesLegs.Wt != tempContentCxWtState.CitiesLegs.Wt)
				return false;
